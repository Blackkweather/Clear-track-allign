...
@section('content')
    ...
    <section class="bg-waves-light">
        ...
        <p>Si vous n’êtes pas d’accord avec les Accords (ou si vous ne pouvez pas vous y conformer), vous ne pouvez pas utiliser le Service, mais vous devez nous le faire savoir en nous envoyant un e-mail à <a href="mailto:contact@cleartrack.ma" class="text-brand-600 underline">contact@cleartrack.ma</a> afin que nous puissions essayer de trouver une solution. Ces Conditions s’appliquent à tous les visiteurs, utilisateurs et autres personnes qui souhaitent accéder au Service ou l’utiliser.</p>

        <h2 class="pt-4 text-xl font-bold text-brand-600">Achats</h2>
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">Contenu</h2>
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">Liens vers d’autres sites web</h2>
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">Modifications</h2>
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">Nous contacter</h2>
