...
@section('content')
    ...
    <section class="bg-waves-light">
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">1. Informations personnelles recueillies</h2>
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">2. Comment nous recueillons les informations</h2>
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">3. Partage de vos informations personnelles</h2>
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">4. Ce que fait Cleartrack avec vos informations personnelles recueillies</h2>
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">5. Protection de vos renseignements personnels</h2>
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">6. Conservation des informations personnelles</h2>
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">7. Maintenance et accès aux informations personnelles</h2>
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">8. Utilisation promotionnelle</h2>
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">9. Divulgation internationale</h2>
        ...
        <h2 class="pt-4 text-xl font-bold text-brand-600">10. Coordonnées</h2>
        ...
        <ul class="list-disc space-y-1 pl-6">
            ...
            <li><a href="mailto:godental.ma@gmail.com" class="text-brand-600 underline">godental.ma@gmail.com</a></li>
